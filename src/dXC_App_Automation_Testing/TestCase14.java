...
public class TestCase14 {
	...
	public void IDDemo() {
		...
		address.selectByVisibleText("domnic sweta, House No C-12, Moradbad 244001, India");
		driver.findElement(By.xpath("//*[@id=\"billing-buttons-container\"]/input")).click();
		//Shipping Address
		
		WebElement Shipp_address_Dropdown = driver.findElement(By.id("shipping-address-select"));
		Select Shipp_address = new Select(Shipp_address_Dropdown);
		Shipp_address.selectByVisibleText("domnic sweta, House No C-12, Moradbad 244001, India");
